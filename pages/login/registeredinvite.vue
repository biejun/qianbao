	...
	<view class="register">
		...
		<view class="login-center">
			<u-cell-group :border="false">
				<u-field label-width="0" v-model="phone" placeholder="请输入注册手机号" :error-message="errorMessage"></u-field>
				<u-field label-width="0" v-model="code" placeholder="请输入短信验证码" :error-message="errorMessage1">
					<u-button size="mini" slot="right" type="error" @click="getCode">{{codeText}}</u-button>
				</u-field>
				<u-field label-width="0" v-model="oldPassword" placeholder="请输入登录密码" :error-message="errorMessage3" password></u-field>
				<u-field label-width="0" v-model="newPassword" placeholder="请再次输入登录密码" :error-message="errorMessage2" password></u-field>
				<u-field label-width="0" v-model="invitation" placeholder="请输入邀请码" :error-message="errorMessage4"></u-field>
